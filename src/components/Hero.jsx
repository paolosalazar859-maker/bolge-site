      ...
      <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-12 items-center z-10">
        ...
        <div className="lg:col-span-7 flex flex-col items-center text-center order-2 lg:order-1 md:items-start md:text-left">
          ...
          >
            {/* Primary CTA */}
            <Link href="/music">
                <a className="group relative px-8 py-4 bg-[#050505] text-white font-medium tracking-[0.15em] text-xs uppercase border border-brand-neon-purple/40 rounded-sm overflow-hidden transition-all duration-500 hover:border-brand-neon-purple hover:shadow-[0_0_25px_rgba(124,58,237,0.35)] cursor-pointer">
            ...
            {/* Secondary CTA */}
            <Link href="/community">
                <a className="relative px-8 py-4 bg-white/5 border border-white/10 text-[#F8FAFC] font-medium tracking-[0.15em] text-xs uppercase rounded-sm overflow-hidden transition-all duration-300 hover:bg-white/10 hover:border-white/20 flex items-center justify-center gap-2 cursor-pointer">
                  SEGUIR EN
                </a>
              </Link>
          </motion.div>
